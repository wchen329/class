...
#define PRISCAS_BRANDING_FULL_VERSION_STRING "1.5.11.2021"
#define PRISCAS_BRANDING_COPYRIGHT "Copyright (c) 2021 Winor Chen"
#define PRISCAS_BRANDING_FULL_VERSION 1,5,11,2021
...
namespace branding
{
	...
	const std::string APPLICATION_VERSION = std::string("1.5");
